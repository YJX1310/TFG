...
public class AcideGrammarFileCreationProcess extends Thread {
	 ...
	 */
//	private static final String _lexer = "src/acide/process/parser/grammar/lexicalCategories.txt";
	/**
	...
	private void reallocateGeneratedFiles() {
		...
		/*
		try {
			AcideByteFileManager.getInstance().copy("Expr.interp",
					"./out/production/Acide/acide/process/parser/grammar/" + "Expr.interp");
		
			AcideByteFileManager.getInstance().copy("Expr.tokens",
					"./out/production/Acide/acide/process/parser/grammar/" + "Expr.tokens");
		
			AcideByteFileManager.getInstance().copy("ExprLexer.interp",
					"./out/production/Acide/acide/process/parser/grammar/" + "ExprLexer.interp");
		
			AcideByteFileManager.getInstance().copy("ExprLexer.tokens",
					"./out/production/Acide/acide/process/parser/grammar/" + "ExprLexer.tokens");
