 ...
 *
 */
public class AcideDebugDatalogPanelShowPredicateListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        AcideDebugHelper.showPredicate(AcideMainWindow.getInstance().getDebugPanel()
