...
/**
 *
 * ACIDE - A Configurable IDE debug datalog panel start debug listener.
 *
 * @version 0.19
 * @see ActionListener
 *
 */
public class AcideDebugDatalogPanelStartDebugListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        AcideDebugHelper.resetColorPredicateNodes();
        AcideDebugHelper.startDatalogDebug();
