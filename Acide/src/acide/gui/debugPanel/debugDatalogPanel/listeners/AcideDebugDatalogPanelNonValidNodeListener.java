...
/**
 *
 * ACIDE - A Configurable IDE debug datalog panel non valid node listener.
 *
 * @version 0.19
 * @see ActionListener
 *
 */
public class AcideDebugDatalogPanelNonValidNodeListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(AcideMainWindow.getInstance().getDebugPanel().getDebugDatalogPanel().isDebugging() &&
            ...
            AcideDebugHelper.startPredicateNodeDebug(predicate, "nonvalid");
        }
        if(AcideDebugDatalogDebugWindow.getInstance().isVisible())
