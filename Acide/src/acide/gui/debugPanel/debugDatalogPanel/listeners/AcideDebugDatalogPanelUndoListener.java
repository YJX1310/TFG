...
/**
 * ACIDE - A Configurable ID debug datalog panel undo listener.
 *
 * @version 0.19
 * @see ActionListener
 *
 */
public class AcideDebugDatalogPanelUndoListener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        AcideDebugHelper.restoreDatalogDebugState("undo",true);
