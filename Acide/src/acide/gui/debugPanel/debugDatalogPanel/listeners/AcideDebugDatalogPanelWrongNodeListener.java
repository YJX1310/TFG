...
/**
 *
 * ACIDE - A Configurable IDE debug datalog panel wrong node listener.
 *
 * @version 0.19
 * @see ActionListener
 *
 */
public class AcideDebugDatalogPanelWrongNodeListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String userInput = AcideDebugHelper.getUserInputDatalogTuple(predicate, "wrong");
        ...
        if(!userInput.isEmpty()){
            ...
            String action = "wrong("+predicate.split("/")[0]+"("+userInput+"))";
            if(AcideDebugHelper.isDatalogSessionDebugging() && !AcideDebugHelper.isRootPredicate(predicate))
