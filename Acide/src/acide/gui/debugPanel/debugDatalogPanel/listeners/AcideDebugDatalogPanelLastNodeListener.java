...
/**
 *
 * ACIDE - A Configurable IDE debug datalog panel last node listener.
 *
 * @version 0.19
 * @see ActionListener
 *
 */
public class AcideDebugDatalogPanelLastNodeListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try{
            ...
            }while(selectedNodeIndex+1<AcideDebugDatalogPanel._canvas.get_pathGraph().size());
