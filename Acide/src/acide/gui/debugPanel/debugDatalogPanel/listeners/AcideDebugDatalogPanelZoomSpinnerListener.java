...
/**
 * ACIDE - A Configurable IDE debug datalog panel zoom spinner listener.
 *
 * @see ChangeListener
 * @version 0.19
 *
 */
public class AcideDebugDatalogPanelZoomSpinnerListener implements ChangeListener {
    ...
    public void stateChanged(ChangeEvent ev){
        ...
        AcideDebugDatalogPanel._canvas.changeZoom(new Float(((Integer) ((JSpinner) ev.getSource())
                .getValue()))/100);
