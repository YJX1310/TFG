...
/**
 * ACIDE - A Configurable ID debug datalog panel redo listener.
 *
 * @version 0.19
 * @see ActionListener
 *
 */
public class AcideDebugDatalogPanelRedoListener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        AcideDebugHelper.restoreDatalogDebugState("redo",true);
        if(AcideDebugDatalogDebugWindow.getInstance().isVisible())
