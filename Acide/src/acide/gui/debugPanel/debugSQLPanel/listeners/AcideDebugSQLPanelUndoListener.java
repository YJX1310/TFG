...
/**
 * ACIDE - A Configurable IDE debug SQL undo listener.
 *
 * @version 0.19
 *
 */
public class AcideDebugSQLPanelUndoListener implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        if(AcideDebugSQLDebugWindow.getInstance().isVisible())
            AcideDebugSQLDebugWindow.getInstance().setAlwaysOnTop(false);

        AcideDebugHelper.restoreSQLDebugState("undo",true);
