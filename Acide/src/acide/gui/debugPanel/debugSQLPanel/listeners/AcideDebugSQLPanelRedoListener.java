...
/**
 * ACIDE - A Configurable IDE debug SQL redo listener.
 *
 * @version 0.19
 *
 */
public class AcideDebugSQLPanelRedoListener implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        if(AcideDebugSQLDebugWindow.getInstance().isVisible())
            AcideDebugSQLDebugWindow.getInstance().setAlwaysOnTop(false);

        AcideDebugHelper.restoreSQLDebugState("redo",true);
