...
public class AcideTraceDatalogPanelShowRulesListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent ev) {
		...
		if(AcideMainWindow.getInstance().getDebugPanel()
				.getTraceDatalogPanel().getCanvas().getSelectedNode()!=null)
				AcideMainWindow.getInstance().getDebugPanel().getTraceDatalogPanel().getHighLighter()
					.highLight(AcideMainWindow.getInstance().getDebugPanel().getTraceDatalogPanel()
